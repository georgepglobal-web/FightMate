    ...
    <div className="min-h-[calc(100vh-4rem)] p-4 sm:p-8 bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 dark:from-black dark:via-purple-950 dark:to-black">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 max-w-2xl mx-auto">
          {([
            { page: "log" as const, label: "Log Session", gradient: "from-blue-500 to-cyan-600 hover:from-blue-600 hover:to-cyan-700", shadow: "hover:shadow-blue-500/50", icon: "M12 4v16m8-8H4" },
            { page: "history" as const, label: "History", gradient: "from-green-500 to-emerald-600 hover:from-green-600 hover:to-emerald-700", shadow: "hover:shadow-green-500/50", icon: "M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z" },
            { page: "avatar" as const, label: "Avatar Evolution", gradient: "from-yellow-500 via-orange-500 to-red-500 hover:from-yellow-600 hover:via-orange-600 hover:to-red-600", shadow: "hover:shadow-orange-500/50", icon: "M13 10V3L4 14h7v7l9-11h-7z" },
            { page: "ranking" as const, label: "Group Ranking", gradient: "from-purple-500 to-pink-600 hover:from-purple-600 hover:to-pink-700", shadow: "hover:shadow-purple-500/50", icon: "M9 12l2 2 4-4M7.835 4.697a3.42 3.42 0 001.946-.806 3.42 3.42 0 014.438 0 3.42 3.42 0 001.946.806 3.42 3.42 0 013.138 3.138 3.42 3.42 0 00.806 1.946 3.42 3.42 0 010 4.438 3.42 3.42 0 00-.806 1.946 3.42 3.42 0 01-3.138 3.138 3.42 3.42 0 00-1.946.806 3.42 3.42 0 01-4.438 0 3.42 3.42 0 00-1.946-.806 3.42 3.42 0 01-3.138-3.138 3.42 3.42 0 00-.806-1.946 3.42 3.42 0 010-4.438 3.42 3.42 0 00.806-1.946 3.42 3.42 0 013.138-3.138z" },
          ]).map(({ page, label, gradient, shadow, icon }) => (
            <button key={page} onClick={() => setPage(page)} className={`group relative overflow-hidden bg-gradient-to-br ${gradient} text-white font-bold py-6 px-6 rounded-2xl shadow-2xl transform transition-all duration-300 hover:scale-105 ${shadow} border-2 border-white/20 backdrop-blur-sm`}>
          ...
          <button onClick={() => setPage("sparring")} className="group relative overflow-hidden bg-gradient-to-br from-red-600 to-orange-600 hover:from-red-700 hover:to-orange-700 text-white font-bold py-6 px-6 rounded-2xl shadow-2xl transform transition-all duration-300 hover:scale-105 hover:shadow-red-500/50 border-2 border-white/20 backdrop-blur-sm sm:col-span-2">
            <div className="absolute inset-0 bg-white/0 group-hover:bg-white/10 transition-colors duration-300" />
            <div className="relative flex items-center justify-center gap-3">
